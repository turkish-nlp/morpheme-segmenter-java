...
public class mcmc_segmenter {
    ...
    public mcmc_segmenter(String file, String inputFile) throws IOException, ClassNotFoundException {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
      /*  Set<String> affixes = new HashSet<>();
        ...
        mcmc_segmenter s = new mcmc_segmenter(args[0], args[1]);
...
/* old method
    ...
    public void deSerialize(String file) throws IOException, ClassNotFoundException {
        ...
        morphemeFreq = model.getSerializedFrequencyTable();
